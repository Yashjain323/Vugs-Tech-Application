...
public class ElectronicItems extends AppCompatActivity {
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference myRef = database.getReference("VUGS TECH");
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_electronic_items);
        ArrayAdapter adapter = new ArrayAdapter<String>(this,R.layout.activity_listview,
                getResources().getStringArray(R.array.electronics));

        ListView listView = (ListView) findViewById(R.id.electronicList);
